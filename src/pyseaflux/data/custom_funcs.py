...
def era5_coarsen_to_1deg(ds_025deg):
    ...
    assert (lat025.size > 600) & (lat025.size < 740), (
        "Latitude dimension is not correct"
    )
    assert (lon025.size > 1430) & (lon025.size < 1480), (
        "Longitude dimension is not correct"
    )
