...
jra_meta = {
    ...
    'citation': 'KOBAYASHI, S., OTA, Y., HARADA, Y., EBITA, A., MORIYA, M., ONODA, H.,  ONOGI, K., KAMAHORI, H., KOBAYASHI, C., ENDO, H., MIYAOKA, K.,  TAKAHASHI, K. (2015). The JRA-55 Reanalysis: General Specifications and  Basic Characteristics. Journal of the Meteorological Society of Japan.  Ser. II, 93(1), 5-48. https://doi.org/10.2151/jmsj.2015-001',
...
class RDAMScookies:
    def __init__(self):
        ...
        self.__author__ = "Doug Schuster (schuster@ucar.edu), Riley Conroy (rpconroy@ucar.edu)"
...
def grib_to_netcdf(input_filename, output_filename, load_first=False, overwrite=False):
    ...
    Returns:
        str: returns the output_filename if successfull
    """
    ...
    xds.to_netcdf(
        output_filename, 
        encoding={k: {'complevel':4, 'zlib':True} for k in xds})
...
def calculate_wind_speed(flist, u='u10', v='v10'):
    ...
    wind_speed_moments = (
        wind_speed
        .resample(time='1MS', loffset='14D').mean()  # monthly resolution
...
def get_jra55_wind_speed(
    ...
    for y in years:
        ...
        grib_names += download(
            ...
            dest=download_dest.format(year=y, file_format='grib'), # store the data per year
    ...
    jra_meta['processing'] = (
        ...
        'pacakge. Variables without dimensions have been dropped. ')
