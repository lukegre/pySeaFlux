...
def make_jra55_wind_speed(
    ...
    jra_meta["grib_source"] = download_dest.format(t0="YYYY", file_format="grib")
    create_download_readme(
        "README.md",
        dest=str(path(download_dest.format(file_format="netcdf")).parent),
        meta=jra_meta,
    )
    ...
    jra_meta["netcdf_source"] = download_dest.format(t0="YYYY", file_format="netcdf")
    create_download_readme("README.md", dest=str(process_dest.parent), meta=jra_meta)
